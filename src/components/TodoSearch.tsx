...
export default class TodoSearch extends React.Component<Props> {
      ...
      <div className="todo-search">
        <div className="todo-search__search-bar">
          <input 
            ...
            value={query}
            onChange={(event) => { this.handleOnChange(event.target.value, undefined) }}
          />
        </div>
        <div className="todo-search__show-completed">
          <label htmlFor="show-completed">
            <input 
              ...
              onChange={() => { this.handleOnChange(undefined, !showCompleted) }}
            />
  ...
  private handleOnChange = (query?: string, showCompleted?: boolean) => {
    if (this.props.onSearch) {
      ...
      const returnShowCompleted = showCompleted !== undefined ? showCompleted : this.props.showCompleted;
